...
class CallConfiguration:
    ...
    def __init__(self, connection_string, source_identity, source_phone_number, app_base_url,EventCallBackRoute, audio_file_name):
        ...
        EventCallBackRoute = EventCallBackRoute
        self.app_callback_url: str = app_base_url + EventCallBackRoute
